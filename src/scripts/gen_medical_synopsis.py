...
model = "gpt-4o-2024-08-06" # [gpt-4o-mini-2024-07-18, gpt-4o-2024-08-06]

paraphrased_dataset = True # [True, False]
definitions_root_path = "llm_medical_terms/"
retriever_results_root_path = ""
llm_keywords_root_path = "gpt_4o_out/"
q_d_relevance_root_path = "gpt_4o_out/"
...
def generate_text(prompt, model = "gpt-4o-mini-2024-07-18", tokenizer = None, max_new_tokens = 512):
...
if paraphrased_dataset:
    ...
    with open(f"paraphrased_datasets/{dataset}_query_paraphrased_gpt4o.json") as f:
        # Load the JSON data into a Python dictionary
        queries = json.load(f)

    print("Loaded Paraphrased Queries!")
