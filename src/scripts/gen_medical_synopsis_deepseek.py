...
prompt_type = "zero_shot" # prompting [zero_shot, cot]
model = "deepseek-chat" # [deepseek-chat, deepseek-reasoner]

paraphrased_dataset = False
definitions_root_path = "llm_medical_terms/"
retriever_results_root_path = ""
llm_keywords_root_path = "deepseek_out/"
q_d_relevance_root_path = "deepseek_out/"
...
def generate_text(prompt, model = "deepseek-chat", tokenizer = None, max_new_tokens = 512):
